...
def obtener_nombre(pais): # Función que devuelve el nombre de cada país al ser llamada por sorted()
    return pais['nombre']

def obtener_poblacion(pais):# Función que devuelve la poblacion de cada país al ser llamada por sorted()
    return pais['poblacion']

def obtener_superficie(pais): # Función que devuelve la superficie de cada país al ser llamada por sorted()
    return pais['superficie']


def ordenar_por_nombre(paises, descendente=False): #Función que devuelve la lista ordenada por el nombre 
...
def ordenar_por_poblacion(paises, descendente=False): #Función que devuelve la lista ordenada por la población
...
def ordenar_por_superficie(paises, descendente=False): #Función que devuelve la lista ordenada por la superficie
